...
export default {
  ...
  methods: {
    async getContact(){
      const resData = await axios.get("http://localhost:8000/api/contact/");
    ...
    await axios.post("http://localhost:8000/api/contact/",sendData);
    ...
    async updateContact(id,name,email){
      ...
      await axios.put("http://localhost:8000/api/contact/" + id,sendData);
      await this.getContact();
    },
